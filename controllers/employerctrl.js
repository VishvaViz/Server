...
const getAppliedTrainingEmployer = async (req, resp) => {
    ...
    try {
        if (req.user?.role === 'employer') {
            ...
            //     {
            //         '$match': {
            //             // 'trainingDetails.trainingPostDetails.postedById': new mongoose.Types.ObjectId(_id),
            //             'trainingDetails.appliedStatus': false,
            //             'trainingDetails.applicationstatus': { $ne: 'Denied' }
            //         }
            //     },
            ...
            //         $lookup: {
            //             from: 'employers',
            //             localField: 'trainingDetails.trainingPostDetails.postedById',
            //             foreignField: '_id',
            //             as: 'employerDetails'
            //         }
            ...
            //             'trainerDetails': { $first: '$trainerDetails' }
            //         }
            //     },
            //     {
            //         $set: {
            ...
            //         },
            //         $set: {
            //             'trainingDetails.trainingPostDetails.postedByName': 'employerDetails.fullName',
            //             'trainingDetails.trainingPostDetails.postedByCompanyName': 'employerDetails.companyName',
            //             'trainingDetails.trainingPostDetails.postedByDesignation': 'employerDetails.designation',
            //             'trainingDetails.trainingPostDetails.postedByImg': 'employerDetails.basicInfo.profileImg'
            //         }
            //     },
            //     {
            ...
            //             'trainerName': '$trainerDetails.fullName',
            //             'trainerDesignation': '$trainerDetails.basicInfo.designation',
            //             'employerFullName': '$employerDetails.fullName',
            //             'employerCompanyName': '$employerDetails.companyName',
            //             'employerDesignation': '$employerDetails.designation',
            //             'employerProfileImg': '$employerDetails.basicInfo.profileImg'

            //         }
            //     }

            // ])
            console.log(getAppliedTraining)
